  ...
  return (
    ...
    >
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className=" lg:py-6  lg:w-1/2 lg:pr-12 lg:text-left text-center">
            <div className="flex-grow flex flex-col justify-center h-full ">
              <h2 className="text-3xl font-semibold text-blue-600 lineBefore relative pl-16">
                Portfolio
              </h2>
              <p className="text-7xl font-semibold leading-tight" mt="4" mb="0">
                Hello, My
                <br />
                Name's Mohamed.
                <br />
      ...
      <motion.div
        ...
        animate="animate"
        exit={{ opacity: 0 }}
        className="bg-gray-50 py-24 font-poppins"
      >
        <div className=" bg-gray-50 text-center lg:text-left lg:ml-28 mb-24">
          <div className="container mx-auto " variants={stagger}>
            <h1
              variants={fadeInUp}
              className="text-3xl font-bold text-blue-600 lineBefore relative pl-16 "
            >
              Projects
            </h1>
            <p
            ...
            {data.map((proj) => (
              ...
              >
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                  className=" sm:w-full lg:w-1/2 max-w-2xl mx-4 my-8 text-center bg-white rounded-lg  cursor-pointer hover:shadow-2xl transition-all duration-300 ease-in-out"
                >
